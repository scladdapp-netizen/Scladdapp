...
const Class_detail_Layout = ({
  ...
  console.log("Class_detail_Layout rendered", { title, subtitle });
  ...
  return (
    ...
    >
      ...
      <div className={`apt_left ${open ? "open" : ""}`}>
        <ClassSidebar sessionData={sessionData} />
      </div>
...
export default Class_detail_Layout;
